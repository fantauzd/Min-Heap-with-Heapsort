...
class DynamicArray:
    ...
    def pop(self) -> object:
        """
        Removes and Returns the last value in the Dynamic Array. If the array is empty, returns None.
    ...
    def peek(self) -> object:
        """
        Returns the last value in the Dynamic Array. If the array is empty, returns None.
